...
export const graphicsEngine: Project = {
    ...
    details: {
        ...
        statusNotes: 'Goraud Shader, and model import implementations next for implementation.',

        goals: [
            'Gain experience in working with smaller software development projects',
            ...
            'Learn and implement various powerful design patterns. E.g. factory, singleton, and subscriber and publisher.'
        ],
        ...
        solutions: [
            ...
            'Unfamiliarity with APIs - SDL2\'s C API was my first introduction in using any substantial libraries as a core component in a program. Throwing myself at the problem and developing a solution on the fly, as well as utilizing the previously mentioned resources helped me along in learning and eventually becoming more comfortable with this concept.',
            ...
            'Codebase upkeep tasks - More time and effort would be best invested into the planning stage of my next project. I learned that refactoring is an essential part of the software development process, but this project required more than I felt should have been necessary. This indicated to me that I needed to devote more time into the planning stage, and less into the implementation stage.',
            'Adherence to modern standards - Performed research online via other\'s codebases, various online forums and previously mentioned online resources, performed research into SOLID pricincples.'
        ],
